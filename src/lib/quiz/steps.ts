...
export const steps: Step[] = [
  ...
  // Section 3 — What you need
  {
    ...
    options: [
      { value: "understand", label: "I want to actually understand it", emoji: "🔍" },
      { value: "hard-season", label: "Something hard is happening", emoji: "🌧️" },
      { value: "habit", label: "I want a habit that sticks", emoji: "📅" },
      { value: "group", label: "I'm leading a group", emoji: "👥" },
      { value: "returning", label: "I'm coming back after time away", emoji: "🕊️" },
    ],
  },
  {
    id: "themes",
    ...
    options: [
      ...
      { value: "relationship", label: "A relationship", emoji: "❤️" },
      { value: "money", label: "Money or work", emoji: "💼" },
      { value: "guilt", label: "Guilt", emoji: "⚖️" },
      { value: "doubt", label: "Doubt", emoji: "❓" },
      { value: "grief", label: "Grief", emoji: "🕯️" },
      { value: "purpose", label: "Purpose", emoji: "🧭" },
      { value: "nothing", label: "Nothing specific", emoji: "🌤️" },
    ],
  },
  {
    id: "outcome",
  ...
  // Section 4 — Your rhythm
  {
    ...
    options: [
      ...
      { value: "bed", label: "Right before bed", emoji: "🌙" },
    ],
  },
  {
    id: "days",
